    ...
    <div class="container">
      ...
      <div class="table">
        <el-table :data="tableData" stripe>
          ...
          <el-table-column label="总评成绩" prop="score" />
      ...
      <el-dialog :visible.sync="editing" title="编辑" width="30%">
        <el-form :model="entityForm" label-width="120px" ref="form">
          ...
          <el-form-item label="平时成绩-实验">
            <el-input type="number" v-model="expScore"></el-input>
          </el-form-item>
          <el-form-item label="平时成绩-签到">
            <el-input type="number" v-model="signScore"></el-input>
          </el-form-item>
          <el-form-item label="平时成绩-作业">
            <el-input type="number" v-model="workScore"></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    save() {
      this.entityForm.dailyScore =
        this.expScore * 0.25 + this.signScore * 0.25 + this.workScore * 0.5;
      this.entityForm.score =
        this.entityForm.dailyScore * 0.3 + this.entityForm.examScore * 0.7;
